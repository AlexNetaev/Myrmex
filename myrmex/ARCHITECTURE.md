...
| **PlannerCaste** | MEASURE | Plant Experimente mit OFAT-Methode |
...
| **ArchivistCaste** | (zukünftig) | Komprimiert und archiviert Wissen |
| **HypothesizerCaste** | (zukünftig) | Generiert neue Hypothesen |
| **PlaceholderCaste** | Fallback | Platzhalter für noch nicht implementierte Kasten |
...
|----------|------|----------|---------|
| **LOOP_A** | Simulation | SIMULATE | -5 pro Iteration |
| **LOOP_B** | Experiment | MEASURE, ANALYZE | +20 pro MEASURE |
| **LOOP_C** | Knowledge | CONSOLIDATE, VALIDATE | -10 pro Iteration |
| **LOOP_D** | Coordination | (zukünftig) | Variabel |
