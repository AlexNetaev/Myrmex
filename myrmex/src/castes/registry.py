...
class CasteRegistry:
    ...
    def _register_defaults(self) -> None:
        ...
        # HypothesizerCaste registrieren
        self.register(ActionType.HYPOTHESIZE, HypothesizerCaste)
        
        # PlannerCaste registrieren
        self.register(ActionType.PLAN, PlannerCaste)
